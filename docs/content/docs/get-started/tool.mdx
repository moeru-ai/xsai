...
A type definition to extend the `options.tools` type of `@xsai/generate-text`.

You should import it when using `@xsai/tool`, it will not increase the size of the package.
