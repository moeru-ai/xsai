...
const effectJsonSchema = await toJsonSchema(Schema.standardSchemaV1(effectSchema)) // [!code highlight]
...
const effectJsonSchema = toJsonSchemaSync(Schema.standardSchemaV1(effectSchema)) // [!code highlight]
